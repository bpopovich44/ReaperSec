...
send_email=${path_kitchen}-file="${path_kjb}daily_core_last60_ERROR.kjb"
...
core_last60(){
	...
	${path_sbin}"${platform}_core_last60.py"
	check_db=$(${mysql_db}"SELECT NULL FROM "${platform}_core_last60" LIMIT 1")
