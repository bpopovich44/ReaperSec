...
def connect():
    ...
    report_book=[189983, 189984, 189985, 189986, 189987, 189989]    
    ...
    try:
        ...
        if conn.is_connected():
            ...
            sql = "DROP TABLE IF EXISTS dna_InventorySources_v2"
            cursor.execute(sql)

            sql = "CREATE TABLE dna_InventorySources_v2 (rownum INT NOT NULL AUTO_INCREMENT PRIMARY KEY, date varchar(25), inventory_source varchar(255), geo_country varchar(50), \
