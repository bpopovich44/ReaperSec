...
def connect():
    ...
    # Each report is a block of 4 hour increments
    report_book=[190592, 190593, 190594, 190595, 190596, 190597]
    ...
    try:
        ...
        if conn.is_connected():
            ...
            sql = "DROP TABLE IF EXISTS adsym_InventorySources_v2"
            cursor.execute(sql)

            sql = "CREATE TABLE adsym_InventorySources_v2 (rownum INT NOT NULL AUTO_INCREMENT PRIMARY KEY, date varchar(25), inventory_source varchar(255), geo_country varchar(50), \
