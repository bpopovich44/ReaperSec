            ...
            while True:
                ...
                if len(info) >= 1:
                    if db_updated == False:
                        ...
                        sql = "CREATE TABLE springserve_inventoryreport_EOM (date varchar(25), source_id varchar(10), \
                ...
                print(str(todaytime) + "  Running springserve_inventoryreport_EOM.  Page # " + str(page) + " Count " + str(len(info)))
	            ...
	            sql = """INSERT INTO springserve_inventoryreport_EOM VALUES ("%s", "%s", "%s", "%s", \
                            "%s", "%s", "%s", "%s")""" % (date, source_id, supply_source, country, \
