...
##
#
# Script runs and checks core_today_media database tables accross all platforms
#
##
...
file5="oath_core_today_media.py"

script="core_today_media.py"
table="core_today_media"
...
#run_core_today_media > >(tee -a ${path_hourly_log}) 2> >(tee -a ${path_error_log} >&2) 
