...
##
#
# Script runs and checks market_last60 database tables accross all platforms
#
##
...
file5="oath_market_last60.py"

script="market_last60.py"
table="market_last60"
...
launch_processes(){
	...
	do
		[[ "$?" == "0" ]] && market_last60 ${platform} || return 1
	done
...
#run_market_last60 > >(tee -a ${path_hourly_log}) 2> >(tee -a ${path_error_log} >&2) 
