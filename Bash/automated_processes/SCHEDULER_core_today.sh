...
##
#
# Script runs and checks core_today database tables accross all platforms
#
##
...
file5="oath_core_today.py"

script="core_today.py"
table="core_today"
...
launch_processes(){
	...
	do
		[[ "$?" == "0" ]] && core_today ${platform} || return 1
	done
...
#run_core_today > >(tee -a ${path_hourly_log}) 2> >(tee -a ${path_error_log} >&2) 
