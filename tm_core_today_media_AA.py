...
def connect():
    ...
    try:
        ...
        if conn.is_connected():
            ...
            sql = "DROP TABLE IF EXISTS tm_core_today_media"
            cursor.execute(sql)
    
            sql = "CREATE TABLE tm_core_today_media (inventory_source varchar(255), media varchar(255), ad_opportunities bigint, \
            ...
            result = aol_api.run_existing_report(logintoken, "190136")
            #print(result)
