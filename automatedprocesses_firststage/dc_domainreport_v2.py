...
def connect():
    ...
    try:
        ...
        if conn.is_connected():
            ...
            sql = "DROP TABLE IF EXISTS dc_domainreport_v2"
            cursor.execute(sql)

            sql = "CREATE TABLE dc_domainreport_v2 (date varchar(25), media varchar(255) CHARACTER SET 'utf8',ad_opportunities bigint, \
            ...
            result = aol_api.run_existing_report(logintoken, "143520")
            #print(result)
            ...
            for x in json.loads(result)['data']:
                ...
                sql = """INSERT INTO dc_domainreport_v2 VALUES ("%s", "%s", "%s", "%s", "%s",\
